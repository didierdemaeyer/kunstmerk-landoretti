...
@section('content')
	...
	{!! Breadcrumbs::render('myauctions.create')  !!}
	...
	<div class="container">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					@if ($errors->has('artist'))
						{!! Form::text('artist', null, ['class' => 'form-control error', 'id' => 'artist', 'placeholder' => 'Artist name'])  !!}
					@else
						{!! Form::text('artist', null, ['class' => 'form-control', 'id' => 'artist', 'placeholder' => 'Artist name'])  !!}
					@endif
				</div>
			</div>
			<div class="col-md-3">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group">
					{!! Form::label('height', 'Height (in cm)') !!}
			...
			<div class="col-md-3">
				<div class="form-group">
					<label for="depth">Depth (in cm) <span class="optional">(optional)</span></label>
					@if ($errors->has('depth'))
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group fileupload">
					<input type="file" name="image_artwork" class="filestyle" data-input="false" data-icon="false"
					       data-buttonText="Upload image <br>of the artwork">
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group fileupload">
					<input type="file" name="image_signature" class="filestyle" data-input="false" data-icon="false"
					       data-buttonText="Upload image <br> of the signature">
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group fileupload">
					<input type="file" name="image_optional" class="filestyle" data-input="false" data-icon="false"
					       data-buttonText="Optional image">
				</div>
			</div>
		</div>
