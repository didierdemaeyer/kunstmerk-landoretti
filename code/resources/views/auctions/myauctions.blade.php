					...
					@if(count($activeAuctions))
						<table class="table table-bordered">
							...
							@foreach($activeAuctions as $auction)
								<tr>
									<td class="img-preview"><a href="{{ route('auctions.show', $auction->slug) }}" style="background-image:url({{ $auction->image_artwork }});"><span class="overlay"><i class="fa fa-search"></i></span></a></td>
									<td>
										<h3>{{ $auction->title }}</h3>
